...
from torchts.nn.layers.attend import Attend
from torchts.nn.layers.RevIN import RevIN
...
class iTransformer(Module):
    ...
    def __init__(
        ...
        self.reversible_instance_norm = RevIN(num_variates,
                                              affine=reversible_instance_norm_affine) if use_reversible_instance_norm else None
